...
$student_result = mysql_query("SELECT * FROM Users,Students WHERE Account_Type = 'student' && Users.uID = Students.uID && Students.teacher_id = '".stripslashes($_SESSION['uID'])."'");
...
print "<tr><td>".stripslashes($a_student_row['UserName'])."</td>";
